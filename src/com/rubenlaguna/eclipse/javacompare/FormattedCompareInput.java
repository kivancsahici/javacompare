...
/*
				...
				if (tmpOutputFromFormatter != null) {
					// to convert from TextEdit to String we must pass it to a
					// Document
					...
					final StringInput toReturn = new StringInput(
							elementToFormat.getType(),
							elementToFormat.getName(), formattedText);
					return toReturn;
				} else {
